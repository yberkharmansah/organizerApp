<template>
    <div class="login-container d-flex justify-content-center align-items-center vh-100">
      <div class="login-card shadow-lg p-5">
        <h1 class="login-title text-center mb-4">Kayıt Ol</h1>
        <form @submit.prevent="registerUser">
          ...
          <button type="submit" class="btn btn-custom w-100 rounded-pill">Kayıt Ol</button>
        </form>
  
        <p class="text-center mt-3">
          Zaten bir hesabınız var mı?
          <router-link to="/login" class="text-decoration-none">Giriş Yap</router-link>
        </p>
      </div>
    </div>
  </template>
